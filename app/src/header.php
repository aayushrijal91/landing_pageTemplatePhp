...
<head>
	...
	<script>
		grecaptcha.ready(function () {
			grecaptcha.execute('<?= $recaptcha_client_secret ?>', { action: 'contact' }).then(function (token) {
	...
	<header>
		<div class="header-top-bar">
			<div class="container py-3 px-lg-5">
				<div class="row justify-content-center justify-content-lg-between align-items-center my-lg-3">
					<div class="col-auto">
						<a href="./">
					...
					<div class="col-auto col-lg font-weight-bold">
						<div class="row justify-content-center justify-content-lg-end no-gutters align-items-center">
							<div class="col-12 col-md-auto ml-lg-3 mr-2 mr-lg-0">
								<a href="#form-quote"
									class="btn btn-block btn-primary rounded-0 text-white py-3 px-md-5 font-weight-bold">
									Get A Quote
								</a>
							</div>
							<div class="col-12 col-md-auto ml-lg-2">
								<a href="tel:<?= $phone_number ?>"
									class="btn btn-block btn-secondary rounded-0 text-white py-3 px-md-5 font-weight-bold">
